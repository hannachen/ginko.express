      ...
      <div className={classes.inner}>
        <div className={classes.content}>
          <Title order={1} className={classes.title}>
            Ginko <span className={classes.highlight}>Anime North</span>
          </Title>
          <Text c="dimmed" mt="md">
            Our takeout booth is back! These items are for sale in front of our
            restaurant during Anime North, they are NOT available for
            dine&#8209;in.
          </Text>
          <Title order={2} mt={30}>
            Booth Hours
